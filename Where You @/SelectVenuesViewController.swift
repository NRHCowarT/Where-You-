...
//        [mapView setRegion:mapRegion animated: YES];
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("venueCell", forIndexPath: indexPath) as SelectVenueTableViewCell
    ...
    func selectUsersVenue(sender: UIButton) {
        let venue = foundVenues[sender.tag] as [String:AnyObject]
